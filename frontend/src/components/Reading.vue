  ...
  <div>
    ...
    <div class="reading-container">
      ...
      <div v-if="showForm" class="add-book-form">
        <input v-model="newTitle" placeholder="タイトル（必須）" />
        <input v-model="newDescription" placeholder="メモ（任意）" />
        <button @click="addBook" :disabled="!newTitle.trim()">追加</button>
        <button @click="showForm = false">キャンセル</button>
      </div>
